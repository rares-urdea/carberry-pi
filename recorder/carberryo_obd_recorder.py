...
from carberry_io import carberry_sensors
from utils.carberry_utils import scanSerial
from carberry_io import carberry_io
import time
import getpass
...
class OBDRecorder:
    ...
    def connect(self):
        ...
        for port in portnames:
            self.port = carberry_io.OBDPort(port, None, 2, 2)
    ...
    def add_log_item(self, item):
        for index, e in enumerate(carberry_sensors.SENSORS):
            if(item == e.shortname):
    ...
    def record_data(self):
        ...
        while 1:
            ...
            for index in self.sensorlist:
                ...
                results[carberry_sensors.SENSORS[index].shortname] = value;
...
o = OBDRecorder('/home/'+username+'/pyobd-pi/log/', logitems)
o.connect()
